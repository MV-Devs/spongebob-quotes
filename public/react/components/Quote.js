...
export const Quote = () => {
  ...
  useEffect(() => {
    ...
    <div id="newQuoteButton">
      ...
      <button onClick={() => URL()} style={{padding: "5px", margin: "10px"}}>Add your own quote</button>  <br></br>
      <button style={{padding: "5px", margin: "10px", borderStyle: 'solid'}} >Edit Quote</button> <br></br>  
      <button style={{padding: "5px", margin: "10px"}}>Delete Quote</button>   
   </div>
